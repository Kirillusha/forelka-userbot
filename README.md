...
- При загрузке модулей через dlm/lm показываются метаданные.
- help [название модуля] показывает метаданные модуля.
- Для авторов модулей: можно добавить __meta__ через meta_lib.build_meta(...)
  или указать __author__ / __version__ / __description__ в файле модуля.
